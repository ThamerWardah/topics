    ...
    return(
        <div className="px-1 py-1 pb-10">
            ...
            <div className="bg-red-400/20 py-4 rounded">
                <p className="text-xs font-semibold  text-gray-200 mb-2 text-justify px-1">If you’re measuring your success to someone else’s, you’re setting yourself up for frustration. I know because I’ve been there. In fact, I still struggle with comparing myself to others.
                </p>

                <p className="text-xs font-semibold  text-gray-200 mb-2 text-justify px-1">Do you remember that first day back to school after winter break? Everyone would show up in their new clothes and would be talking about the new gaming device or toy they received over the holidays.
                </p>

                <p className="text-xs font-semibold  text-gray-200 mb-2 text-justify px-1">
                ...
                <div className="py-10 flex flex-col gap-10">
                    {story.map((item,index)=><div key={index} className="space-y-2 bg-slate-700/50 py-2 rounded-lg">
                        ...
                        }} className="bg-green-200 text-gray-700 text-xs font-semibold px-2 rounded-lg" >
                            {isReading?"Stop":"Read"}
                        </button>
                    </div>)}
                </div>
